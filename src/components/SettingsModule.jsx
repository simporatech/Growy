...
// Options formatted for CustomSelect using full AVAILABLE_CURRENCIES catalog
  ...
  return (
    <div className="w-full space-y-6 animate-fadeIn pb-8">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full relative z-30">
        <div>
          ...
          <p className="text-sm text-slate-300 font-normal mt-1">
            {t('settings.subtitle', {}, 'Personaliza la apariencia, temas dinámicos, moneda global y respaldos de información')}
          </p>
        </div>
      </header>

      {statusMessage && (
        <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-bold animate-fadeIn flex items-center gap-2">
