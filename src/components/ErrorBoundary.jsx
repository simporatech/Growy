    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#0E1517] p-6 selection:bg-[var(--accent,#97F2CC)] selection:text-[var(--accent-text,#091E15)]">
          <div className="w-full max-w-md p-8 bg-[#0D1117]/95 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl text-center flex flex-col items-center animate-in fade-in zoom-in-95 duration-200">
